...
* запись в файл **ПО УМОЛЧАНИЮ ОТКЛЮЧЕНА** и включается только отдельной локальной конфигурацией/флагом (не обязательна для v1).

Если включена запись логов в файл, реализация **ДОЛЖНА** обеспечивать локальную retention-политику (см. раздел 2.1).

---

## 5) Support bundle (по явному включению, v1)
